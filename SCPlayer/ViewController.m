...
- (AVPlayer *)player {
    if (!_player) {
        //初始化播放器对象
        _player = [[AVPlayer alloc] initWithURL:[NSURL URLWithString:@"http://app-new.pudongtv.cn:8006/MP4http/gx1/pddst/video/2019/11/12/e238306ea17d5468599bc2a6749cbba0/playlist.m3u8"]];
